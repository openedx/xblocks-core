...
class VideoBlockImportTestCase(TestCase):
    ...
    @patch("xblock_video.block.VideoBlock.import_video_info_into_val")
...
class VideoBlockStudentViewDataTestCase(unittest.TestCase):
    ...
    @patch("xblock_video.block.VideoBlock.is_hls_playback_enabled", Mock(return_value=True))
    @patch("xblock_video.video_transcripts_utils.get_available_transcript_languages", Mock(return_value=["es"]))
