...
class ProblemBlockTest(unittest.TestCase):
    ...
    def test_rescore_problem_correct(self):
        ...
        with patch("xblock_problem.capa.responsetypes.LoncapaResponse.evaluate_answers") as mock_evaluate_answers:
    ...
    def test_rescore_problem_not_supported(self):
        ...
        # Try to rescore the problem, and get exception
        with patch("xblock_problem.capa.capa_problem.LoncapaProblem.supports_rescoring") as mock_supports_rescoring:
    ...
    def _rescore_problem_error_helper(self, exception_class):
        ...
        # Simulate answering a problem that raises the exception
        with patch("xblock_problem.capa.capa_problem.LoncapaProblem.get_grade_from_current_answers") as mock_rescore:
